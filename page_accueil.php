...
$livresCarousel = $stmt->fetchAll(PDO::FETCH_ASSOC); // stocke les 3 derniers livres

// Tous les livres avec infos auteur
$stmt = $pdo->query("SELECT livre.*, auteur.nom AS nomAuteur, auteur.prenom AS prenomAuteur
                     FROM livre
                     INNER JOIN auteur ON livre.noauteur = auteur.noauteur");
$tousLivres = $stmt->fetchAll(PDO::FETCH_ASSOC); // stocke tous les livres
?>
